...
int main(int argc, char* argv[]){
	...
	char actual[55] = "/sys/class/backlight/panel_backlight/actual_brightness";
	char max[52] = "/sys/class/backlight/panel_backlight/max_brightness";
  	char bright[48] = "/sys/class/backlight/panel_backlight/brightness";
